namespace Flavorful.Repository.Data
{
    public class StoreContextSeed
    {
        public async static Task SeedAsync(StoreContext _dbContext)
        {
            ...
            {
                string brandsData = File.ReadAllText("../Flavorful.Repository/Data/DataSeeding/brands.json");
            ...
            {
                string categoriesData = File.ReadAllText("../Flavorful.Repository/Data/DataSeeding/categories.json");
            ...
            {
                string productsData = File.ReadAllText("../Flavorful.Repository/Data/DataSeeding/products.json");
            ...
            {
                string deliveryMethodsData = File.ReadAllText("../Flavorful.Repository/Data/DataSeeding/delivery.json");
