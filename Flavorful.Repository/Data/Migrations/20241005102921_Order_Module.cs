...
namespace Flavorful.Repository.Data.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DelivryMethodId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_DeliveryMethods_DelivryMethodId",
                        column: x => x.DelivryMethodId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_DelivryMethodId",
                table: "Orders",
                column: "DelivryMethodId");
        }
